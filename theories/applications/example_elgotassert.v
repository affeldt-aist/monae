...
(*                                                                            *)
(* This file proves partial correctness of the Bubble Sort algorithm not      *)
(* changing the list length. The main theorem is bubblesort_length.           *)
(* ```                                                                        *)
(*        sortl == for all elements, swap them if their order is reversed     *)

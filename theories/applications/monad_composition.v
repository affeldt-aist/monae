...
Require Import preamble hierarchy monad_lib.
...
rewrite /=.
rewrite (up_compA (Join \o M # swap)).
rewrite -(up_compA Join (M # swap)).
rewrite (natural ret).
by rewrite (up_compA Join) joinretM up_compidf Hswap2.
Qed.

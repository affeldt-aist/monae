...
- [[fail_monad.v][fail_monad.v]]: lemmas about fail monad and related monads
- [[state_monad.v][state_monad.v]]: lemmas about state-related monads
- [[trace_monad.v][trace_monad.v]]: lemmas about about the state-trace monad
...
- [[https://coq.inria.fr][Coq]] 8.10.2 (8.11.0 for the most recent files wip)
